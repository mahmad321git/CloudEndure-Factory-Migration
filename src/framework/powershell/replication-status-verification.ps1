...
################################################################################
## Starting Replication Status workflow.
################################################################################

Write-Output "Starting Replication Status Workflow..."
& $install_python_folder\python.exe python\start_replication_status_verification_script.py
